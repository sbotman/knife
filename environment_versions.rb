...
class Chef
  class Knife
    class EnvironmentVersions < Knife
      ...
      banner "knife environment versions [ ENVIRONMENT ENVIRONMENT ]"
      ...
      def run
        ...
        if cookbook_col.nil? || cookbook_col.empty?
          ui.error "Cannot find any cookbook constraints"
          exit 1
        end
